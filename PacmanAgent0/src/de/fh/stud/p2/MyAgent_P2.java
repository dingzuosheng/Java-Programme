...
public class MyAgent_P2 extends PacmanAgent {
	...
	/*
	 * TODO Praktikum 2 [1]: Fügt gemäß der Aufgabenstellung neue Attribute
	...
	public void updateState(PacmanPercept percept, PacmanActionEffect actionEffect) {
		...
		/*
		 * TODO Praktikum 2 [1]: Erweitern Sie diese updateState-Methode gemäß der
		 * Aufgabenstellung.
		 */
	}

	/**
	 * In dieser Methode wählt der Agent seine nächste Aktion aus, basierend auf
	 * dem Weltzustand des Agenten.
	 * 
	...
	public PacmanAction action() {
		...
		/*
		 * TODO Praktikum 2 [1]: Erweitern Sie diese action-Methode gemäß der
		 * Aufgabenstellung.
		 */
