...
public class Menu {
	...
	public Menu() {
		...
		String title = "TestDaten";
		String title_b = "TestDaten";
		String ort ="ort_b";
		String interpreter = "TestDaten";
		int jahr =2000;
		int dauer = 20;
		for(int i=0;i<5;i++) {
			mv.aufnehmen(new Bild(title_b, jahr, ort));
	...
	public void medienlisteInDateiSchreiben() throws EmptyFilenameException {
		...
		while (fileName.equals("")) { //  Das Eingabefenster mit cancel 
			...
			if(fileName==null) return; // Das Eingabefenster mit cancel 
		}
...
/*	public void writeToFile() throws EmptyFilenameException {
		String fileName = "";
		fileName = JOptionPane.showInputDialog(null,"Bitte einen Dateiname eingeben");
		if(fileName==null) throw new EmptyFilenameException("Dateiname ist leer");
		while(fileName.equals("")) {
			int wahl = JOptionPane.showConfirmDialog(null,"Dateiname ist leer! Neuen Dateiname eingeben?","Fehler",JOptionPane.YES_NO_CANCEL_OPTION);
	...
	public void writeToFile() throws EmptyFilenameException{
		String filename = JOptionPane.showInputDialog(null,"Bitte einen Dateiname eingeben");
		if(filename==null) return ; //cancel ,danach zeigt Hauptmenue
		while(filename.equals("")) {// Dateiname ist leer,Option mit Yes_No_Option um neuen eingeben.
			int wahl = JOptionPane.showConfirmDialog(null,"Dateiname ist leer,neuen eingeben? ","Fehler",
